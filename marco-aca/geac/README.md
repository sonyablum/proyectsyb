# 🛡 Protocolo GEAC — Gobernanza Ética Algorítmica en Comunicación

> Activo intelectual de Sonia Yánez Blum personal. Licenciado a Blum Digital PR.
> Cierre académico previsto en MEDIAETHICS 2026 (Valladolid · 29-jun a 3-jul).

## Qué es

Protocolo de gobernanza para que organizaciones de comunicación gestionen su **cadena algorítmica** (el recorrido del contenido desde su publicación hasta que un algoritmo decide mostrarlo / resumirlo / ignorarlo) bajo criterios éticos y verificables.

## Tres pasos del protocolo
...
- **ISO/IEC 42001:2023** — gestión de sistemas de IA (PDCA)
- **ISO/IEC 23894** — gestión de riesgo en IA
- GEAC se posiciona como complemento sectorial (cadena de comunicación) que estos marcos no cubren.

## Componentes del sistema GEAC

GEAC integra 4 instrumentos:
...
Ver `marco-aca/delphi-geac/README.md` (Delphi GEAC R1+R2 — instrumento que valida los 4 componentes simultáneamente).
