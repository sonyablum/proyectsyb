...
|---|---|---|
| `brand-spec.md` | Bio del personaje, voz, paleta, símbolos, idioma, narrativa | 🟡 por crear |
| `disclaimer-transparencia-ai.md` | Texto reutilizable para web, RRSS, emails | 🟡 por crear |
| `politica-datos-sensibles.md` | GDPR + privacidad alta esotérico | 🟡 por crear |
| `catalogo-servicios.md` | 3 servicios MVP | 🟡 por crear |
| `prompts/` | Prompts curados por servicio | 🟡 por crear |
| `marketing/` | Copy RRSS, secuencias email, ads | 🟡 por crear |

## Reglas internas de la carpeta
